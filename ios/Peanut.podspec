...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "muayadmohammed" => "muayadmohammed@gmail.com" }
  # Or just: spec.author    = "muayadmohammed"
  # spec.authors            = { "muayadmohammed" => "muayadmohammed@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/muayadmohammed"
